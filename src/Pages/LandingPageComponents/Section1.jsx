    ...
    <Flex mt={100} mb={70} gap={50} p="15px" justify="center">
      ...
      >
        ...
        <Text
          ...
          fontWeight="semibold"
        >
          <Text fontSize='2rem' color="#0056d2" display='inline'>IGJJ</Text> Where Educators and Students Connect Seamlessly Online. Teachers craft personalized courses for various subjects and grades, while students explore and purchase courses tailored to their needs. Empowering both educators and learners, IGJJ revolutionizes online education.
        </Text>
        <Flex
          gap={30}
          direction={{
